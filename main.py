...
__author__ = "A.Hu aka Practical Technologies"
__credits__ = ["IMHUNTERAND"]
__license__ = "GPL"
__version__ = "0.1"
__maintainer__ = "A.Hu aka Practical Technologies"
__email__ = "sibertech@engineer.com"
__git__ = "https://github.com/imhunterand"
__twitter__ = "https://twitter.com/imhunterand"
...
if __name__ == '__main__':
    ...
    python main.py --file domain.txt  --thread 15
    python main.py --file tesla.txt  --ssl
    python main.py --range 192.168.15.1,192.168.15.100 --thread 30 
    python main.py --file domain.gov.txt  --thread 15 --timeout 3 
    python main.py --file subdomain.txt  --debug
